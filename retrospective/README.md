...
- 디자인 시스템 모듈화, 작업 방법 정형화
- 안드로이드 컴포즈, XML 스타일 둘다 유지
- 네비게이션 동작 처리 심화 부분 검토
- 소켓 / 웹소켓 / REST 통신 모듈 정형화
- 로그 시스템 (로그 파일 적재 / 서버 업로드)
- 단위 테스트 앱
- 테스트 코드 작성
- 린트, 포맷터 컨벤션 설정
- 툴 사용법
- 포트폴리오 페이지 / 앱 등 창구 마련
- 코루틴, 스레드, 멀티스레드 복잡한 상황 처리
- 소스 리팩토링 기법 / 디자인 패턴 / 아키텍쳐 패턴 스타일
- 형상관리 툴 사용, 심화적인 사용
- 메모리 관리
- 파이어베이스 활용법
- 소스 빌드, 배포 자동화 방법
- 복잡한 UI 구현/처리 방법
- 미디어 플레이어 개발
- 컬렉션 프레임워크, 자바, 알고리즘 적용
- 데이터 캐싱, 데이터베이스, 파일, 프리퍼런스 활용
- 모바일 1, 2, 3, 4, 서버, 프론트 웹페이지, PC 프로그램 프로젝트 기획
- 과거 개발 활동 정리 후 개발 중 힘들었던 사항, 극복했던 방법 정리 및 재 적용 시도
- 웹페이지, 깃허브 관리 정책
- 이슈 해결 방법 정리할 장소 선정
- 개인 생각 정리할 장소 선정
- 개인 취미 관련 내용 정리 / 업로드할 장소 선정
- 개인 이력, 기술사항 정리할 장소 선정
- 기획과 개발 간 상호 소통 방법
- 개발 공수 일정 산정법
- 시간 활용법
...
- REST_API 에러 핸들링 클린 코드 준비
- Socket 매니저 / 에러 핸들링 클린 코드 준비
- 로거 택
- 범용적인 유틸리티 솔루션 확보
  - 네트워크 변경
  - 토스트
...
- 각각 프레임워크 별 신규 프로젝트 생성
- 기본뷰 구현
- 기본뷰 커스터마이징한 뷰 구현
- 레이아웃 응용 구현
- 유아이 스타일 정의 관련 최적화
- 유틸리티 확장함수 구현
- 현재까지 개발한 앱들에 대한 템플릿 개발
- 각각 파트별 개념 정리 문서 제작
- 개발 시간을 줄이는 데에 필요한 내용 미리 개발
- 여러 패러다임 적용, 옵션으로 패러다임 선택한 개발 구조
- 단순히 클론 코딩 또는 예제 타이핑은 따로 레파지토리 구성하여 진행
- 자바, 코틀린, 자바스크립트, 타입스크립트, 파이썬, 스위프트, 다트
- 네트워크, 디자인패턴, 리팩토링, 데이터베이스 등 추가 응용개념들은 어떻게 정리할 지 고민
- 코딩테스트 문제 풀이는 따로 저장소 생성하여 진행
- 총 6개의 저장소로 운영
- 그동안 프로젝트 진행 중 겪은 기술적인 문제, 협업 및 의사소통 문제 등 정리
- 레거시를 개선하는 활동
- 소프트웨어 이력 정리, 포트폴리오 사이트, SNS정리
- 블로그 운영 필요성 고민, 깃으로만 할지 등
